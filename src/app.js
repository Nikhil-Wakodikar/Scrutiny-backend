...
//static for image
var addr = path.join(__dirname, '../assets/profileIMG')
app.use('/profile', express.static(addr))
var addr = path.join(__dirname, '../assets/storyIMG')
app.use('/image', express.static(addr))
