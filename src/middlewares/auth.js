...
// Verify invited user token
const verifyInvitedUserToken = () => async (req, res, next) => {
  try {
    const user = await authService.verifyInvitedUser(
...
module.exports = { auth, verifyInvitedUserToken };
